/******************** (C) COPYRIGHT 2011 **************************************
* File Name          : timecaltest.c
* Hackeroos          : caw, deh
* Date First Issued  : 07/21/2011
* Board              : STM32F103VxT6_pod_mm
* Description        : Test program for time/temp calibration of 32 KHz osc
*******************************************************************************/

/* NOTE: 
1.  Open minicom on the PC with 115200 baud and 8N1 and this routine
2.  This is a hack of adctest 07/21/2011.
*/
...
#define ADCSAVESIZE	4
struct ADCDR	strADCsave[ADCSAVESIZE];
