/******************** (C) COPYRIGHT 2010 **************************************
* File Name          : USART3_txmin_txbusy.c 
* Hackor             : deh
* Date First Issued  : 10/03/2010 deh
* Description        : USART3 tx minimal, check transmit register emtpy
*******************************************************************************/ 
...
******************************************************************************/
u16 USART3_txmin_busy(void)
{
	return (USART_SR(USART3) & USART_FLAG_TXE);
}
