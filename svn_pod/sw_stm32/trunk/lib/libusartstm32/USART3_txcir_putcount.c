/******************** (C) COPYRIGHT 2010 **************************************
* File Name          : USART3_txcir_putcount.c 
* Hackor             : deh
* Date First Issued  : 10/14/2010 deh
* Description        : Get free tx buffer count: USART3 tx char-by-char interrupt with circular buffer
*******************************************************************************/ 
...
u16 USART3_txcir_putcount(void)
{	
	return usartx_txcir_putcount((u32*)BITBAND(USART3SR,TXFLAG),pUSARTcbt3);
}
