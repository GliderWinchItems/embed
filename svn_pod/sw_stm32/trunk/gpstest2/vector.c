...
void WEAK RTC_IRQHandler(void);	    // rtc_isr(void);
...
void WEAK TIM1_BRK_IRQHandler(void);	// tim1_brk_isr(void);
void WEAK TIM1_UP_IRQHandler(void);	// tim1_up_isr(void);
void WEAK TIM1_TRG_COM_IRQHandler(void);// tim1_trg_com_isr(void);
void WEAK TIM1_CC_IRQHandler(void);	// tim1_cc_isr(void);
...
void WEAK RTC_ALARM_IRQHandler(void);	// rtc_alarm_isr(void);
...
void TIM6_IRQHandler(void);		// tim6_isr(void);
...
//	main,			/* Use main() as reset vector for now. */
	...
	can_sce_isr,
	exti9_5_isr,
	TIM1_BRK_IRQHandler,	//tim1_brk_isr,
	TIM1_UP_IRQHandler,	//tim1_up_isr,
	TIM1_TRG_COM_IRQHandler,//tim1_trg_com_isr,
	TIM1_CC_IRQHandler,	//tim1_cc_isr,
	...
	exti15_10_isr,
	RTC_ALARM_IRQHandler,	// rtc_alarm_isr,
	usb_wakeup_isr,
	tim8_brk_isr,
	tim8_up_isr,
	tim8_trg_com_isr,
