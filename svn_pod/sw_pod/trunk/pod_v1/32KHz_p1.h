 ...
 ******************************************************************************/
 void p1_RTC_cnt_to_tickcounter(void);
/* @brief	: Synchronize/load in-memory counter that mirrors RTC_CNT counter
 ******************************************************************************/
int p1_RTC_cnt_compare_tickcounter(void);
/* @brief	: Synchronize then take difference
 * @return	: (RTC_CNT - uiRTCsystemcounter)
 ******************************************************************************/
