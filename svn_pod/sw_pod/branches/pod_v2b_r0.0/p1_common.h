...
#define GPSARRAYSIZE	14	// Size of SSMMHHDDMMYY
...
#define PKT_GPSFIX_SIZE	100	// Number of chars allowed for longest sentence
struct PKT_GPSFIX
{
	unsigned char id;		// Packet ID
	union LL_L_S 	U;		// 64 bit Linux time
...
#define LAUNCHTIMEREADOUT_TENSION_DN	28000	// Grams tension on way down


// 'p1_launchtime'
#define LAUNCHTIME_TENSION_UP	100000	// Grams tension going upwards
#define LAUNCHTIME_TENSION_DN	28000	// Grams tension at end (going downwards)
