...
#define ADCORDERINAVERAGEMONITOR	10	// Power of two for number in average for monitoring on PC
...
#define ADCTICKADJUSTAVER_ORDER	2		// Power or two for number of ADC readings in average for tickadjust

/* adc[NUMBERADCREADINGSPKT]--
[0] PA 3 ADC123-IN3	Thermistor on 32 KHz xtal
[1] PB 0 ADC12 -IN8	Bottom cell of battery
[2] PB 1 ADC12 -IN9	Top of battery 
*/
...
extern volatile unsigned int uiThermistor_tickadjust;	// Scaled adjustment for thermistor reading
extern volatile unsigned int uiThermistoradcflag;	// Increments when thermistor reading ready for tickadjust
extern volatile unsigned int uiThermistoradcflagPrev;	// Increments when thermistor reading ready for tickadjust
