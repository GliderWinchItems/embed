...
*/
/*	DMA DRIVEN  */
// int bsp_uart_dma_init_number(volatile u32* puart, u32 baud, u32 rxbuffsize, u32 txbuffsize, u32 dmastreamrx, u32 dmastreamtx, u32 dma_tx_int_priority);
...
#define PACECOUNT (16800000/10);	// Pace the output loop
