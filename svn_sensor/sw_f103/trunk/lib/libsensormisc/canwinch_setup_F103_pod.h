/******************************************************************************
* File Name          : canwinch_setup_F103_pod.h
* Date First Issued  : 05-30-2015
* Board              : F103
* Description        : Setup initializtion of CAN1 for winch, F103
*******************************************************************************/
/* 
*/

#ifndef __CANWINCH_SETUP_F103_PODa
#define __CANWINCH_SETUP_F103_PODa
