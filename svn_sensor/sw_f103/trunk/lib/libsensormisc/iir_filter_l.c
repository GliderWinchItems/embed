...
/******************************************************************************
 * static void iir_filter_l_init(struct IIRFILTERL* pfil, int32_t* pval, int32_t scale);
 * @brief	: Set initial value
 * @param	: pfil = pointer to struct with filter stuff
 * @param	: pval = pointer to reading
*******************************************************************************/
static void iir_filter_l_init(struct IIRFILTERL* pfil, int32_t* pval)
{
