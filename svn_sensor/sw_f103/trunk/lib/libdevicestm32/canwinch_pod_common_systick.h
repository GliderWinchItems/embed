/******************** (C) COPYRIGHT 2013 **************************************
* File Name          : canwinch_pod_common_systick.h
* Hackerees          : deh
...
#ifndef __CANWINCH_COMMON
#define __CANWINCH_COMMON

#include "common.h"	// libopenstm32 (u32,...u8)
#include "common_can.h"

//#define NVIC_I2C2_EV_IRQ_PRIORITY 0xb0	// Post TIM4 input capture interrupt processing
...
extern void 	(*systickHIpriority_ptr)(void);		// SYSTICK handler (very high priority)
...
extern u32	fifo1cycnt;	// DTW module 32b processor cycle counter
