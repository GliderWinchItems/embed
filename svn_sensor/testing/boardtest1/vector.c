...
void WEAK TIM1_IRQHandler(void);	// tim1_cc_isr(void);
...
//	(void *)0x20000800,	/* Use 2KB stack (0x800 bytes). */
	(void *)(0x20000000+(20*1024)-1),/* Put 20K stack at top */
...
#pragma weak TIM1_IRQHandler = null_handler
