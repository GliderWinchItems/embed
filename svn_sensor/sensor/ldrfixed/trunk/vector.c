...
void WEAK p1_TIM1_TRG_COM_IRQHandler(void);// tim1_trg_com_isr(void); TIM1 Trigger and Commutation Interrupt and TIM11 global interrupt
...
//	main,			/* Either this or one of the following two */
//	Reset_Handler,	
	unique_can_block,	
	nmi_handler,
	hard_fault_handler,
