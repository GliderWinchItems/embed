...
struct CANWINCHPODCOMMONERRORS
{
	...
	u32 can_tx_alst0_err; 	// Count: arbitration for mailbox0 lost failure total
...
{	
 ...
 printf("%6d %s\n\r",(int)(pcce->can_tx_alst0_err - pprev->can_tx_alst0_err),"can_tx_alst0_err\trbitration for mailbox0 lost failure");
