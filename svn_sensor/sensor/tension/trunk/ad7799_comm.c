...
/******************************************************************************
 * void ad7799_ten_1_initA (unsigned char ucSPS);
...
/******************************************************************************
 * void ad7799_ten_1_initB (unsigned char ucSPS);
...
void ad7799_ten_rd_8bit_reg (unsigned char ucX)
{
	...
	spi1_writedoneptr = &ad7799_ten_rd_8bit_reg1;	// Setup ISR completion address
	ad7799_ten_8bit_wrt = ((ucX & 0x3f)|0x40);		// Setup codes to make next operation a read
	spi1_write (&ad7799_ten_8bit_wrt,1);		//  Write byte to comm reg
	return;						// Return to ISR
}
/* ISR for SPI1 comes here after byte to comm register has been written */
void ad7799_ten_rd_8bit_reg1(void)
{
	spi1_readdoneptr = &ad7799_ten_rd_8bit_reg2;	// Next ISR completion address
	spi1_read (&ad7799_ten_8bit_reg, 1, 0);		// Read one byte
	return;						// Return to ISR
}
...
void ad7799_ten_reset (void)
{
	...
	ad7799_ten_comm_busy = 1;			// Show interest parties sequence is in progress
	spi1_writedoneptr = &ad7799_ten_reset1;	// Setup ISR completion address
	spi1_write ((unsigned char*)&ad7799_ten_ones[0],4);		// Send 32 all one bits
	return;
}
...
void ad7799_ten_rd_16bit_reg (unsigned char uc)
{
	while (ad7799_ten_comm_busy != 0);			// If main did not check we must hang for prev sequenc
	ad7799_ten_comm_busy = 1;				// Show interest parties sequence is in progress
	spi1_writedoneptr = &ad7799_ten_rd_16bit_reg1;	// Setup ISR completion address
...
void ad7799_ten_rd_16bit_reg1(void)
{
	spi1_readdoneptr = &ad7799_ten_rd_16bit_reg2;	// Next ISR completion address
	spi1_read (&ad7799_ten_16bit.uc[0], 2, 0);		// Read high ord byte
	return;						// Return to ISR
}
...
void ad7799_ten_rd_24bit_reg (unsigned char uc)
{
	...
	spi1_writedoneptr = &ad7799_ten_rd_24bit_reg1;	// Setup ISR completion address
	ad7799_ten_8bit_wrt = ((uc & 0x3f)|0x40);		// Setup codes to make next operation a read
	spi1_write (&ad7799_ten_8bit_wrt,1);		// Write byte to comm register
	return;						// Return to mainline
}
/* ISR for SPI1 comes here after byte to comm register has been written */
void ad7799_ten_rd_24bit_reg1(void)
{
	spi1_readdoneptr = &ad7799_ten_rd_24bit_reg2;	// Next ISR completion address
	spi1_read (&ad7799_ten_24bit.uc[0], 3, 0);		// Read high ord byte
	return;						// Return to ISR 
}
/* ISR for SPI1 comes here after 2nd byte from specified register has been written */
void ad7799_ten_rd_24bit_reg2(void)
...
void ad7799_ten_wr_16bit_reg (unsigned char uc)
{
	while (ad7799_ten_comm_busy != 0);			// If main did not check we must hang for prev sequenc
	ad7799_ten_comm_busy = 1;				// Show interest parties sequence is in progress
	spi1_writedoneptr = &ad7799_ten_wr_16bit_reg1;	// Setup ISR completion address
...
void ad7799_ten_wr_16bit_reg1(void)
{
	spi1_writedoneptr = &ad7799_ten_wr_16bit_reg2;	// Next ISR completion address
	spi1_write (&ad7799_ten_16bit.uc[1], 1);		// Write high ord byte
	return;
}
/* ISR for SPI1 comes here after 1st byte from specified register has been written */
void ad7799_ten_wr_16bit_reg2(void)
{
	spi1_writedoneptr = &ad7799_ten_wr_16bit_reg3;	// Next ISR completion address
	spi1_write (&ad7799_ten_16bit.uc[0], 1);		// Write low ord byte
	return;
}
/* ISR for SPI1 comes here after 2nd byte from specified register has been written */
void ad7799_ten_wr_16bit_reg3(void)
