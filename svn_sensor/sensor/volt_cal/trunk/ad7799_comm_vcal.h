...
#define AD7799_RD_MODE_REG		(ad7799_vcal_rd_16bit_reg( (1 << 3) )) // Register selection code: 001
#define AD7799_RD_CONFIGURATION_REG	(ad7799_vcal_rd_16bit_reg( (2 << 3) )) // Register selection code: 010
#define AD7799_RD_DATA_REG		(ad7799_vcal_rd_24bit_reg( (3 << 3) )) // Register selection code: 011
#define AD7799_RD_ID_REG		(ad7799_vcal_rd_8bit_reg(  (4 << 3) )) // Register selection code: 100
#define AD7799_RD_IO_REG		(ad7799_vcal_rd_8bit_reg(  (5 << 3) )) // Register selection code: 101
#define AD7799_RD_OFFSET_REG		(ad7799_vcal_rd_24bit_reg( (6 << 3) )) // Register selection code: 110
#define AD7799_RD_FULLSCALE_REG		(ad7799_vcal_rd_24bit_reg( (7 << 3) )) // Register selection code: 111
