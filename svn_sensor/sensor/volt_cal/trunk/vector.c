...
void WEAK DMA1CH1_IRQHandler_vcal(void);	//DMA1CH1_IRQHandler(void);	// dma1_channel1_isr(void);
...
void WEAK EXTI9_5_IRQHandler(void);	// exti9_5_isr(void);
...
void WEAK TIM2_IRQHandler_vcal(void);	// tim2_isr(void);
void WEAK TIM3_IRQHandler_yog(void);	// tim3_isr(void);
void WEAK TIM4_IRQHandler(void);	// tim4_isr(void);
void WEAK I2C1_EV_IRQHandler_vcal(void);	// i2c1_ev_isr(void);
void WEAK I2C1_ER_IRQHandler_vcal(void);	// i2c1_er_isr(void);
void WEAK I2C2_EV_IRQHandler_yog(void);	// i2c2_ev_isr(void);
void WEAK I2C2_ER_IRQHandler_yog(void);	// i2c2_er_isr(void);
void WEAK SPI1_IRQHandler_vcal(void);	// spi1_isr(void);
...
void WEAK FSMC_IRQHandler_yog(void);	//fsmc_isr(void);
...
//	(void *)0x20000800,	/* Use 2KB stack (0x800 bytes). */
	(void *)(0x20000000+(64*1024)-4),/* Put stack at top */
//	main,			/* Use main() as reset vector for now. */
	...
	exti0_isr,
	exti1_isr,
	EXTI2_IRQHandler, //exti2_isr,
	EXTI3_IRQHandler, //exti3_isr,
	exti4_isr,
	DMA1CH1_IRQHandler_vcal, //DMA1CH1_IRQHandler,	//dma1_channel1_isr,
	...
	EXTI9_5_IRQHandler,	//exti9_5_isr,
	...
	TIM2_IRQHandler_vcal,	//tim2_isr,
	TIM3_IRQHandler_yog,	//tim3_isr,
	TIM4_IRQHandler,	//tim4_isr,
	I2C1_EV_IRQHandler_vcal,	//i2c1_ev_isr,
	I2C1_ER_IRQHandler_vcal,	//i2c1_er_isr,
	I2C2_EV_IRQHandler_yog,	//i2c2_ev_isr,
	I2C2_ER_IRQHandler_yog,	//i2c2_er_isr,
	SPI1_IRQHandler_vcal,	//spi1_isr,
...
#pragma weak EXTI2_IRQHandler = null_handler	//exti2_isr = null_handler
#pragma weak EXTI3_IRQHandler = null_handler	//
#pragma weak exti4_isr = null_handler
#pragma weak DMA1CH1_IRQHandler_vcal = null_handler 	//dma1_channel1_isr = null_handler
...
#pragma weak EXTI9_5_IRQHandler = null_handler
...
#pragma weak TIM2_IRQHandler_vcal = null_handler
#pragma weak TIM3_IRQHandler_yog = null_handler	//tim3_isr = null_handler
#pragma weak TIM4_IRQHandler = null_handler
#pragma weak I2C1_EV_IRQHandler_vcal = null_handler
#pragma weak I2C1_ER_IRQHandler_vcal = null_handler
#pragma weak I2C2_EV_IRQHandler_yog = null_handler
#pragma weak I2C2_ER_IRQHandler_yog = null_handler
#pragma weak SPI1_IRQHandler_vcal = null_handler	//spi1_isr = null_handler
...
#pragma weak FSMC_IRQHandler_yog = null_handler	//fsmc_isr = null_handler
