...
#define TIM2_PRIORITY_CO	0x10	// Interrupt priority for TIM2 interrupt
#define TIM3_PRIORITY		0x20	// Interrupt priority for TIM3 interrupt
#define TIM4_PRIORITY_CO	0x20	// Interrupt priority for TIM3 interrupt (GPS 1 PPS)
#define NVIC_I2C2_EV_IRQ_PRIORITY_CO 0x90	// Post TIM4 input capture interrupt processing
#define NVIC_I2C2_ER_IRQ_PRIORITY_CO 0xe0	// Post TIM2 interrupt processing (CAN logging)
