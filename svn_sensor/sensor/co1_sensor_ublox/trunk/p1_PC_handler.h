...
#define SIZESTARTSTOP	26	// Minimum number of chars in a valid input line for command 'd'
#define SIZESLAUNCHTIME	9	// Minimum number of chars in a valid input line for command 'k'
