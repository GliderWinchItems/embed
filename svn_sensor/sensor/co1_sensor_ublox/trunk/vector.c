...
void WEAK TIM1_BRK_TIM9_IRQHandler(void);	// tim1_brk_isr(void);
...
//	(void *)(0x20000000+(20*1024)-1),/* Put stack at top */
...
//	main,			/* Use main() as reset vector for now. */
	...
	exti9_5_isr,
	TIM1_BRK_TIM9_IRQHandler,	//tim1_brk_isr,
	...
	I2C1_EV_IRQHandler,	//i2c1_ev_isr,	canwinch_pod (co1_Olimex)
	I2C1_ER_IRQHandler,	//i2c1_er_isr,	canwinch_pod (co1_Olimex) 
	I2C2_EV_IRQHandler,	//i2c2_ev_isr,	Tim4_pod_se  (co1_Olimex)
	I2C2_ER_IRQHandler,	//i2c2_er_isr,	canwinch_pod (co1_Olimex) (logging)
...
#pragma weak TIM1_BRK_TIM9_IRQHandler = null_handler
