...
void WEAK DMA1CH1_IRQHandler_yogurt(void);	//DMA1CH1_IRQHandler(void);	// dma1_channel1_isr(void);
...
void WEAK I2C1_ER_IRQHandler_yog(void);	// i2c1_er_isr(void);
...
//	main,			/* Use main() as reset vector for now. */
	...
	exti3_isr,
	exti4_isr,
	DMA1CH1_IRQHandler_yogurt, //DMA1CH1_IRQHandler,	//dma1_channel1_isr,
	...
	I2C1_ER_IRQHandler_yog,	//i2c1_er_isr,
...
#pragma weak DMA1CH1_IRQHandler_yogurt = null_handler //dma1_channel1_isr = null_handler
...
#pragma weak TIM3_IRQHandler = null_handler	//tim3_isr = null_handler
#pragma weak TIM4_IRQHandler = null_handler
#pragma weak I2C1_EV_IRQHandler = null_handler
#pragma weak I2C1_ER_IRQHandler_yog = null_handler
