...
/* ********** Static routines **************************************************/
static void adcsensor_yogurt_init(void);
static void adcsensor_yogurt_start_conversion(void);
static void adcsensor_yogurt_start_cal_register_reset(void);
static void adcsensor_yogurt_start_calibration(void);

/* CIC routines buried somewhere below */
static void adc_cic_filtering_yogurt(void);
static void adc_cic_init_yogurt(void);
...
*******************************************************************************/
const struct PINCONFIGALL pin_therm1 = {(volatile u32 *)GPIOC, 0, IN_ANALOG, 0};
const struct PINCONFIGALL pin_therm2 = {(volatile u32 *)GPIOC, 1, IN_ANALOG, 0};
const struct PINCONFIGALL pin_therm3 = {(volatile u32 *)GPIOC, 2, IN_ANALOG, 0};
const struct PINCONFIGALL pin_therm4 = {(volatile u32 *)GPIOC, 3, IN_ANALOG, 0};
...
static void adcsensor_yogurt_init(void)
{
	...
	ADC1_SMPR1 = ( (SMP13 << 9) | (SMP12 << 6) | (SMP11 << 3) | (SMP10 << 0) );
	...
	// Load channels IN10, IN11, IN12, IN13, for conversions sequences
	ADC1_SQR3 = (10 << 0) | (11 << 5) | (12 << 10) | (13 << 15); 
...
/******************************************************************************
 * static unsigned int adcsensor_yogurt_start_conversion(void);
 ...
 *####################################################################################### */
void DMA1CH1_IRQHandler_yogurt(void)
{
...
static void adc_cic_init_yogurt(void)
{
	...
	dma_ll_ptr = &adc_cic_filtering_yogurt;
 ...
 * ############################################################################################### */
/* 
   This routine is entered from  'FSMC_IRQHandler' via 'dma_ll_ptr' triggered by 'DMA1CH1_IRQHandler_yogurt'
*/
