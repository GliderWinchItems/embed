...
#define CAN_TIMESYNC	((0 << CAN_UNITID_SHIFT) | CAN_RIxR_RTR) 	// GPS time sync distribution msg (CAN setup for no error retry - NART in CAN_MCR, p 649)
...
#define CAN_UNITID_SE1	(1  << CAN_UNITID_SHIFT)	// Sensor unit: Upper sheave shaft encoder
#define CAN_UNITID_SE2	(2  << CAN_UNITID_SHIFT)	// Sensor unit: Lower sheave shaft encoder
#define CAN_UNITID_SE3	(3  << CAN_UNITID_SHIFT)	// Sensor unit: Drive shaft encoder
#define CAN_UNITID_ENG	(4  << CAN_UNITID_SHIFT)	// Sensor unit: Engine 
#define CAN_UNITID_LVL	(5  << CAN_UNITID_SHIFT)	// Sensor unit: Level wind
#define CAN_UNITID_XB1	(6  << CAN_UNITID_SHIFT)	// Sensor unit: XBee receiver #1
#define CAN_UNITID_XB2	(7  << CAN_UNITID_SHIFT)	// Sensor unit: XBee receiver #2
#define CAN_UNITID_DSP	(8  << CAN_UNITID_SHIFT)	// Display driver
#define CAN_UNITID_CO	(9  << CAN_UNITID_SHIFT)	// CO
#define CAN_UNITID_POD1	(10 << CAN_UNITID_SHIFT)	// POD board hack prototype #1
#define CAN_UNITID_PODCO (11 << CAN_UNITID_SHIFT)	// POD board hack for CO prototype
