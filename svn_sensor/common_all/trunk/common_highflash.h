...
*******************************************************************************/
#ifndef __SVN_SENSOR_HIGHFLASH
#define __SVN_SENSOR_HIGHFLASH

/* ### 05/15/2016 REDIRECT from svn_sensor based, TO svn_common BASED. ### */
#include "common_highflash.h"

#ifdef adfakljdflaejroqioamdvlmaeropimnvm
...
//        5 - double
//        6 - long double
//        7 - string of chars (zero termination added after 1st double space, or
