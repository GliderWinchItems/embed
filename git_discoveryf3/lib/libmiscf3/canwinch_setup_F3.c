...
{ NVIC_USB_HP_CAN1_TX_IRQ,  NVIC_CAN2_TX_IRQ_PRIORITY},	/* TX  interrupt (number & interrupt priority) */
{ NVIC_USB_LP_CAN1_RX0_IRQ, NVIC_CAN2_RX0_IRQ_PRIORITY},	/* RX0 interrupt (number & interrupt priority) */
{ NVIC_CAN1_RX1_IRQ, NVIC_CAN2_RX1_IRQ_PRIORITY},	/* RX1 interrupt (number & interrupt priority) */
...
struct CLOCKSF3* canwinch_setup_F3_clocks(void)
{
	return (struct CLOCKSF3*)&clocks;	// cast to stop 'const' warning
}
/******************************************************************************
* static int canwinch_setup_F3_filter(u32 num);
...
//		break;
	...
	ret = canwinch_setup_F3_filter(cannum);
