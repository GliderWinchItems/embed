/******************************************************************************
* File Name          : cic_filter_l_N2_M3_f3.c
...
/******************************************************************************
 * unsigned short cic_filter_l_N2_M3_f3 (struct CICLN2M3 *strP);
...
long	lX1,lX2;	// Intermediate differentiator value
	...
	strP->lIntegral[0] += strP->nIn;		// Incoming data is 32 bits; add to 32 bit accumulator
	...
	if (strP->usDecimateCt >= strP->usDecimateNum) 	// Time to decimate?
