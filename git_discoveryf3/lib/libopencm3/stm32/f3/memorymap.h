...
#define BX_CAN1_BASE			(PERIPH_BASE_APB1 + 0x6400) /* deh */
#define BX_CAN2_BASE			(PERIPH_BASE_APB1 + 0x6400) /* deh */
...
/* APB2 */
#define SDADC3_BASE			(PERIPH_BASE_APB2 + 0x6800) /* deh */
#define SDADC2_BASE			(PERIPH_BASE_APB2 + 0x6400) /* deh */
#define SDADC1_BASE			(PERIPH_BASE_APB2 + 0x6000) /* deh */
#define TIM19_BASE			(PERIPH_BASE_APB2 + 0x5C00) /* deh */
...
#define ADC_BASE			(PERIPH_BASE_APB2 + 0x2400) /* deh */
